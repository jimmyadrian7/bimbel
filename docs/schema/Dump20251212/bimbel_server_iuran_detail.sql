...
CREATE TABLE `iuran_detail` (
  ...
  CONSTRAINT `iuran_detail_ibfk_1` FOREIGN KEY (`iuran_id`) REFERENCES `iuran` (`id`),
  CONSTRAINT `iuran_detail_ibfk_2` FOREIGN KEY (`pembiayaan_id`) REFERENCES `pembiayaan` (`id`)
