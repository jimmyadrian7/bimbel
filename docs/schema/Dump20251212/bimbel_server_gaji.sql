...
CREATE TABLE `gaji` (
  ...
  CONSTRAINT `gaji_ibfk_1` FOREIGN KEY (`guru_id`) REFERENCES `guru` (`id`),
  CONSTRAINT `gaji_ibfk_2` FOREIGN KEY (`pengeluaran_id`) REFERENCES `pengeluaran` (`id`)
