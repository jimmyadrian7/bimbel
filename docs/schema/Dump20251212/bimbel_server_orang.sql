...
CREATE TABLE `orang` (
  ...
  `nama_mandarin` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `hobi` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `no_hp_ortu` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `no_rek_ortu` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pp_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `agama_id` (`agama_id`),
  CONSTRAINT `orang_ibfk_1` FOREIGN KEY (`agama_id`) REFERENCES `agama` (`id`)
