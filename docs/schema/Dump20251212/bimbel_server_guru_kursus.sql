...
DROP TABLE IF EXISTS `guru_kursus`;
...
CREATE TABLE `guru_kursus` (
  ...
  CONSTRAINT `guru_kursus_ibfk_1` FOREIGN KEY (`guru_id`) REFERENCES `guru` (`id`),
  CONSTRAINT `guru_kursus_ibfk_2` FOREIGN KEY (`kursus_id`) REFERENCES `kursus` (`id`)
